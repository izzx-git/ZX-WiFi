...
v.1.6 - Вместо U2, U6, Q1, J1 поставлена ATF16V8B (GAL16V8). Добавлен сигнал MREQ (пока не используется).
	...
	В Evo c активным расширителем шины (ёлке на 4 слота) может не стабильно работать в слоте 3 и дальше от основной платы компьютера.
	В слотах 1-2 расширителя и без ёлки работает стабильно.
